...
<html>
        ...
        <div class="container-fluid" style="border: groove 10px greenyellow">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <form action="crearHotel" method="post" name="formulario" id="formulario" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" value="<c:out value="${hotel.nombreHotel}"/>" class="form-control" id="nombreH" name="nombreH" placeholder="Introduzca el nombre   " maxlength="30" data-translate="p_nombreH">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control" value="<c:out value="${hotel.telefono}"/>" id="telefono" name="telefono" placeholder="Introduzca el telefono del hotel  " maxlength="9"  style="margin-top: 15px">
                            </div>

                            <div class="form-group col-md-4">

                                <label for="correo"><strong data-translate="correo">Correo</strong></label><br>
                                <input type="text" class="form-control"  value="<c:out value="${hotel.correo}"/>" id="correo" data-translate="correo" name="correo" placeholder="Introduzca el correo  " maxlength="50" >
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="number" class="form-control"  id="precio" data-translate="precio" name="precio" placeholder="Introduzca el precio  "  value="0" min="0" step="0.5">
                        ...
                        <button  type="submit" class="btn btn-success" name="crear" id="crear" style="margin-left: 500px" data-translate="crear">Crear</button>
                        <button  type="button" class="btn btn-danger" name="cancelar" id="cancelar" data-translate="cancelar">Cancelar</button>
    ...
    <script type="text/javascript" src="${contexto}/JS/validacionHotel.js"></script>
