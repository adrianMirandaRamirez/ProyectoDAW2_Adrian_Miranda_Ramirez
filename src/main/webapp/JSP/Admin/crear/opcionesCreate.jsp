<%-- 
    Document   : opcionesCreate
    Created on : 19-sep-2020, 11:16:47
    Author     : adrian
--%>
    ...
    <body style="background-color: white">
        <div class="container-fluid" style="border: groove 10px greenyellow">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <form action="crearHotel" method="post">
                        
                        <input type="submit" name="boton" value="1- A&ntilde;adir hotel" class="btn col-6 btn-primary"  id="opciones" />
                        <input type="submit" name="boton" value="2- A&ntilde;adir atividad" class="btn col-6 btn-primary"  id="opciones" />
