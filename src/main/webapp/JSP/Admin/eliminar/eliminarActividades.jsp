<%-- 
    Document   : eliminarActividades
    Created on : 22-sep-2020, 12:03:54
    Author     : adrian
--%>
            ...
            <div class="row">
                ...
                <div class="col-12">
                   ...
                   <c:forEach var="elemento" items="${sessionScope.actividades}">
                       <input type="checkbox" value="${elemento.idActividad}"  name="actividad" style="margin-left: 550px"/>
                        <label><strong><c:out value="${elemento.nombreActiv}:${elemento.lugar}"/></strong></label>
                        <br>
                    </c:forEach>
                         <button  type="submit" class="btn btn-primary" name="elimActiv" id="eliminarActiv">Eliminar</button>
