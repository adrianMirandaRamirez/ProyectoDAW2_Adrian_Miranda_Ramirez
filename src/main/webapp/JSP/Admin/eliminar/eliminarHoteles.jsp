        ...
        <div class="container-fluid" style="border: groove 10px greenyellow">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <c:forEach var="elemento" items="${sessionScope.hoteles}">
                        <input type="checkbox" value="${elemento.idHotel}"  name="hotel" style="margin-left: 550px"/>
                        <label><strong><c:out value="${elemento.nombreHotel}:${elemento.lugar}"/></strong></label>
                        <br>
                    </c:forEach>
                        
                          <button  type="submit" class="btn btn-primary" name="elimHotel" id="eliminarHotel">Eliminar</button>
