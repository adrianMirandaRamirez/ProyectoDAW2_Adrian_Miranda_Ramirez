<%-- 
    Document   : eliminarHoteles
    Created on : 22-sep-2020, 12:03:40
    Author     : adrian
--%>
...
<html>
    <head>
        ...
        <jsp:useBean id="reserva" scope="page"  class="es.albarregas.beans.Reservas" /> 
        <title>EliminarReserva</title>
    </head>
    <body style="background-color: white">
        <div class="container-fluid" style="border: groove 10px greenyellow">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <h2 id="tituloList">Seleccione los elementos que desea borrar</h2>
                    <form action="OperacionEliminar" method="post">
                    <c:forEach var="elemento" items="${sessionScope.reservas}">
                        <input type="checkbox" value="${elemento.idReserva}"  name="reserva" style="margin-left: 550px"/>
                        <label><strong><c:out value="${elemento.idHotel.nombreHotel}:${elemento.idHotel.lugar}:${elemento.fechaReserva}"/></strong></label>
                        <br>
                    </c:forEach>
                        
                          <button  type="submit" class="btn btn-primary" name="elimReserva" id="eliminarReserva">Eliminar</button>
