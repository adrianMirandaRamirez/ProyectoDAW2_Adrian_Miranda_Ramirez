<%-- 
    Document   : opcionesEliminar
    Created on : 22-sep-2020, 11:45:37
    Author     : adrian
--%>
    ...
    <body style="background-color: white">
        <div class="container-fluid" style="border: groove 10px greenyellow">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <form action="OpcionEliminar" method="post">
                        
                        <input type="submit" name="boton" value="1- Eliminar hoteles" class="btn col-6 btn-primary"  id="opciones" />
                        <input type="submit" name="boton" value="2- Eliminar atividades" class="btn col-6 btn-primary"  id="opciones" />
                        <input type="submit" name="boton" value="3- Volver " class="btn col-6 btn-primary"  id="opciones" />
                        <input type="submit" name="boton" value="4- Eliminar reservas" class="btn col-6 btn-primary"  id="opciones" />
