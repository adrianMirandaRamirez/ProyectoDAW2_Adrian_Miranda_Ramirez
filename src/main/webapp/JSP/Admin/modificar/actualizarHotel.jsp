<%-- 
    Document   : actualizarHotel
    Created on : 24-sep-2020, 12:17:54
    Author     : adrian
--%>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <c:forEach var="elemento" items="${sessionScope.hoteles}">
                        <input type="radio" value="${elemento.idHotel}"  name="hotel" style="margin-left: 550px"/>
                        <label><strong><c:out value="${elemento.nombreHotel}:${elemento.lugar}"/></strong></label>
                        <br>
                    </c:forEach>
                        
                          <button  type="submit" class="btn btn-primary" name="modHotel" id="modificacion" >Modificar</button>
