<%-- 
    Document   : opcionesUpdate
    Created on : 24-sep-2020, 12:07:02
    Author     : adrian
--%>
    ...
    <body style="background-color: white">
        <div class="container-fluid" style="border: groove 10px greenyellow">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <form action="OpcionUpdate" method="post">

                        <input type="submit" name="boton" value="1- Actualizar hoteles" class="btn col-6 btn-primary"  id="opciones" />
                        <input type="submit" name="boton" value="2- Actualizar actividades" class="btn col-6 btn-primary"  id="opciones" />
