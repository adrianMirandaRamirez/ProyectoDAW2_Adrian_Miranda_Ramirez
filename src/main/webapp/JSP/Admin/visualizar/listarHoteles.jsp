<%-- 
    Document   : listarHotels
    Created on : 21-sep-2020, 19:35:06
    Author     : adrian
--%>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <table id="t01">
                        ...
                        <c:forEach var="elemento" items="${requestScope.listaHoteles}">

                            <tr>
                                <td><strong>${elemento.idHotel}</strong></td>
                                <td><strong>${elemento.nombreHotel}</strong></td>
                ...
                <form action="Redireccion" method="post">
                    <button  type="submit" class="btn btn-success" name="menuListados" id="menu">Menu inicial</button>
                </form>
