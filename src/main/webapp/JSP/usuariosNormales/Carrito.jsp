<%-- 
    Document   : Carrito
    Created on : 21-nov-2020, 19:11:38
    Author     : adrian
--%>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <table id="t01">
                        ...
                        <c:forEach var="reserva" items="${requestScope.carrito}">
                ...
                <form action="Redireccion" method="post">
                    <button  type="submit" class="btn btn-success" name="menuCarrito" id="menu">Menu inicial</button>
                </form>
