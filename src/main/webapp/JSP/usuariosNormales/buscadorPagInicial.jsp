<%-- 
    Document   : buscadorPagInicial
    Created on : 27-sep-2020, 12:33:28
    Author     : adrian
--%>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <c:forEach var="elemento" items="${requestScope.hoteles}">
                        ...
                        <c:choose>
                            <c:when test="${fn:startsWith(elemento.fotoHotel, defecto)}">
                ...
                <form action="Redireccion" method="post">
                    <button  type="submit" class="btn btn-success" name="menuPaginaInicial" id="menu">Menu inicial</button>
                </form>
